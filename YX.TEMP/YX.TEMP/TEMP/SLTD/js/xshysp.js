...
$(function () {
    ...
    if ($("input[name='DATA_7']").val() != "" && $("Select[name='DATA_9']").val() != "") {
        //alert(0);
        SecondDisPlay();
    }
...
function Form_Custom_Validate() {
    ...
    if (parseFloat($("input[name='DATA_10']").val()) < parseFloat($("input[name='DATA_11']").val())) {
        alert("该预算科目可用金额少于需要金额！");
        return false;
    }
